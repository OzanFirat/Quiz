...
public class QuizDBHelper extends SQLiteOpenHelper {
    ...
    public void fillQuestionTable(){
        ...
        Question q21 = new Question("Zwischen welchen Jahren fand der 30 Jährige Krieg statt?", "1556 bis 1586", "1618 bis 1648", "1914 bis 1944", "1752 bis 1782", 2, 21, 0, "no",0);
        Question q22 = new Question("Wann war die Reichsteilung im Römischen Reich?", "395 n.C", "41 v.C", "895 n.C", "980 n.C", 1, 22, 0, "no",0);

        //Chemie
        Question q23 = new Question("Ist Erdgas leichter als Luft?", "Ja", "Nein", "Vielleicht", "Keine Ahnung", 1, 23, 0, "no",0);
        Question q24 = new Question("Was ist ein Schwermetall?", "Lithium", "Titan", "Sillizium", "Indium", 4, 24,0, "no",0);
        Question q25 = new Question("Alle Edelmetalle sind ...", "radioaktiv", "Schwermetalle", "Platin Metalle", "keine Metalle", 2, 25,0, "no",0);
        Question q26 = new Question("Welches Metall hat die größte Dichte?", "Gold", "Iridium", "Blei", "Uran", 2, 26,0, "no",0);
        Question q27 = new Question("Welches Getränk enthält über 2000 verschiedene chemische Verbindungen?", "Milch", "Cola", "Wein", "Kaffee", 4, 27,0, "no",0);
        Question q28 = new Question("Das chemische zeichen für Zink?", "Zk", "Zn", "Cn", "Zi", 2, 28, 0, "no",0);
        Question q29 = new Question("Welche Farbe bildet Jod, wenn es sich in Alkohol löst?", "Braun", "Blau", "Gelb", "Rot", 1, 29, 0, "no",0);
        Question q30 = new Question("Welches Element hat den niedrigsten Schmelzpunkt?", "Wasserstoff", "Neon", "Fluor", "Sauerstoff", 1, 30, 0, "no",0);
        Question q31 = new Question("Bei welcher Temperatur wird (unter Normaldruck) Luft flüssig", "0.15K", "-98° C ", "-213° C", "bei keiner", 3, 31,0, "no",0);
        Question q32 = new Question("Wie sind die Doppelbindungen in einer konjugierten Kohlenwasserstoffkette gesetzt?", "abwechselnd", "irgendwie", "gar nicht", "am Ende und am Anfang", 32, 15,0, "no",0);
        Question q33 = new Question("Extrem reaktionsträge Stoffe wie Glas und die Edelgase sind ...", "alkalisch", "alert", "chalkogen", "inert", 4, 33,0, "no",0);

        //Tierwelt
        Question q34 = new Question("Sind Termiten große Ameisen?", "Ja", "Nein", "Könnte sein", "Hab kein Spickzettel", 2, 34,0, "no",0);
        Question q35 = new Question("Wie heißt das asiatische Hochgebirgsrind?", "Wagyu", "Kobe Bryant", "Yang", "Yak", 4, 35, 0, "no",0);
        Question q36 = new Question("Was ist Guano?", "Affenart", "Fisch", "Droge", "Vogelkot", 4, 36, 0, "no",0);
        Question q37 = new Question("Wie nennt man weibliche Pferde?", "Alpha Weibchen", "Stute", "Hengst", "Pony", 2, 37, 0, "no",0);
        Question q38 = new Question("Wie groß ist eine Giraffe?", "ca. 8 Meter", "ca. 5 Meter", "ca. 7 Meter", "ca. 6 Meter", 4, 38,0, "no",0);
        Question q39 = new Question("Die Nachahmung wehrhafter Tiere durch Form- und Farbanpassung nennt man ...?", "Mimose", "Mimik", "Mimikry", "Mime", 3, 39,0, "no",0);
        Question q40 = new Question("Glühwürmchen sind ...", "Würmer", "Zecken", "Kaefer", "Bienen", 3, 40,0, "no",0);
        Question q41 = new Question("Wie nennt man die Welt der Tiere?", "Fabel", "Fauna", "Sauna", "Haivana", 2, 41,0, "no",0);
        Question q42 = new Question("Wie viele Flügel hat eine Biene?", "2", "3", "4", "6", 3, 42, 0, "no",0);
        Question q43 = new Question("BWie viele Beine hat eine Krabbe?", "4", "6", "8", "12", 3, 43, 0, "no",0);
        Question q44 = new Question("Die Giraffe reisst die Blätter mit der Zunge vom Baum. Was für eine Farbe hat ihre Zunge?", "Weiss", "Rot", "Blau", "Rosa", 3, 44, 0, "no",0);

        //Geographie
        Question q45 = new Question("Der Teil des Mittelmeeres zwischen Griechenland und der Türkei heißt...", "Der Golf von Mexiko", "Adriatisches Meer", "Mittelmeer", "Aegaeisches Meer", 4, 45,0, "no",0);
        Question q46 = new Question("Die Mojavewüste liegt in ...", "Asien", "Balkan", "Afrika", "Nordamerika", 4, 46,0, "no",0);
        Question q47 = new Question("Welche Sprache ist die Amtssprache im Iran?", "Arabisch", "Persisch", "Iranisch", "Paschto", 2, 47,0, "no",0);
        Question q48 = new Question("In welchem Land liegt die größte Wüste Amerikas?", "USA", "Brasilien", "Argentinien", "Kanada", 3, 48,0, "no",0);
        Question q49 = new Question("Welche der gennanten Programmier Sprachen ist die älteste?", "ASP", "PERL", "C#", "JAVA", 2, 49, 0, "no",0);
        Question q50 = new Question("Die Hauptstadt von Uruguay ist...", "Montevideo", "Bogota", "Vuvuzuela", "Baskia", 1, 50, 0, "no",0);
        Question q51 = new Question("In welcher Gebirgskette ist der K2 (der zweithöchste Berg der Welt)?", "Karakorum", "Anden", "Himalaya", "Kaukasus", 1, 51, 0, "no",0);
        Question q52 = new Question("Welches afrikanische Land hat die größte Fläche?", "Algerien", "Mali", "Sudan", "Libyen", 1, 52,0, "no",0);
        Question q53 = new Question("Wie viele Sterne sieht man auf Kubas Flagge?", "1", "2", "3", "keine", 1, 53,0, "no",0);
        Question q54 = new Question("Welches Land wird `Grüne Insel` genannt?", "Irland", "Bahrain", "Costa Rica", "Island", 1, 54,0, "no",0);
        Question q55 = new Question("Paramaribo ist die Hauptstadt von ...", "Ecuador", "Suriname", "Guyana", "Belize", 2, 55,0, "no",0);

        //Religion
        Question q56 = new Question("Wo steht Christi Geburtskirche?", "Jerusalem", "Bethlehem", "Nazareth", "Haifa", 2, 56, 0, "no",0);
        Question q57 = new Question("Wie heißt Versöhnungstag auf Hebräisch?", "Gemara", "Jom Kippur", "Jom An-Nur", "Rosch Ha-Schana", 2, 57, 0, "no",0);
        Question q58 = new Question("Was ist keines der fünf Bücher Mose?", "Genesis", "Numeri", "Hesekiel", "Leviticus", 3, 58, 0, "no",0);
        Question q59 = new Question("In welcher Religion spielt Reinkarnation eine große Rolle?", "Islam", "Taoismus", "Christentum", "Hinduismus und Buddhismus", 4, 59,0, "no",0);
        Question q60 = new Question(" Mit welchem Tag beginnt das katholische Kirchenjahr?", "1. Advent", "Silvester", "Ostermontag", "37614", 1, 60,0, "no",0);
        Question q61 = new Question("Wie nannten die Griechen den Strom des Vergessens in der Unterwelt?", "Acheron", "Lethe", "Hades", "Styx", 2, 61,0, "no",0);
        Question q62 = new Question("Über welche Kirche erhebt sich die größte gemauerte Kuppel der Welt?", "Petersdom", "Stephansdom", "Karlskirche", "Mailaender Dom", 1, 62,0, "no",0);
        Question q63 = new Question("Wer rief 1096 zum ersten Kreuzzug auf?", "Papst Leo III.", "Papst Urban I.", "Kaiser Friedrich Barbossa I. (Rotbart)", "Papst Urban II.", 4, 63, 0, "no",0);
        Question q64 = new Question("Was bedeutet orthodox?", "Aberglauben verfallen", "rechtgläubig", "linksgläubig", "heidnisch", 2, 64, 0, "no",0);
        Question q65 = new Question("Wann gab es die letzte Hinrichtung wegen Hexerei in England?", "1685", "1495", "1895", "1817", 1, 65, 0, "no",0);
        Question q66 = new Question("Welcher Staat der USA gilt als Heimat der Mormonen?", "Utah", "Texas", "Iowa", "Wisconsin", 1, 66,0, "no",0);
