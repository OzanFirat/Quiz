...
public class QuizDBHelper extends SQLiteOpenHelper {
    ...
    public void fillQuestionTable(){
        //Computer und IT
        Question q1 = new Question("Wie schreibt man IP-Adressen (IPv4)?", "8 durch Doppelpunkt getrennte Hexadezimal Zeichen", "32-Bit stellige binäre Zahl ", "10 Stellige dezimale Zahl", "4 durch Punkt getrennte Zahlen", 4, 1, 0, "no", 0, 1, 1, 1);
        ...
        Question q67 = new Question("A is correct", "A", "B", "C", "D", 1, 15,0, "no",0, 0,0,0);
        Question q68 = new Question("A is correct", "A", "B", "C", "D", 1, 16,0, "no",0, 0,0,0);
        Question q69 = new Question("A is correct", "A", "B", "C", "D", 1, 17,0, "no",0, 0,0,0);
        Question q70 = new Question("Welche der gennanten Programmier Sprachen ist die älteste?", "ASP", "PERL", "C#", "JAVA", 2, 11, 0, "no",0, 0,0,0);
        Question q71 = new Question("B is correct", "A", "B", "C", "D", 2, 12, 0, "no",0, 0,0,0);
        Question q72 = new Question("C is correct", "A", "B", "C", "D", 3, 13, 0, "no",0, 0,0,0);
        Question q73 = new Question("D is correct", "A", "B", "C", "D", 4, 14,0, "no",0, 0,0,0);
        Question q74 = new Question("A is correct", "A", "B", "C", "D", 1, 15,0, "no",0, 0,0,0);
